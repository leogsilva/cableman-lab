...
export DNS_DOMAIN="cluster3.local"
export POD_NET="10.3.0.0/16"
export SRV_NET="100.3.0.0/16"
...
kubectl apply -f "https://cloud.weave.works/k8s/net?k8s-version=v1.20.1&env.IPALLOC_RANGE=10.3.0.0/16"
kubectl taint nodes --all node-role.kubernetes.io/master-
kubectl label node u3 submariner.io/gateway=true
